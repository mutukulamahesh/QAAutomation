...
public class UpdateEmail extends Setup {
	String profileID1 = "";
	@Test(groups = { "sanity", "OWS", "UpdateEmail_TC001" })
  public void UpdateEmail_TC001() {
		
		HashMap<String, String> resDetails;
		HashMap<String, String> reqDetails;
		List resDifferences;
		ArrayList<String> actualDifferencess;
		String emailOperaID = null;
		
		
		
		
		String testName = "UpdateEmail_TC001";
		WSClient.startTest(testName, "Verify UpdateEmail RQ & RS parameters", "minimumRegression");
...
//					WSClient.setData("{var_profileId}", profileID1);
					 ...
					 *  Insert Email
					 */
					WSClient.writeToReport(LogStatus.INFO, "Preparing to execute InsertEmail operation");
					reqDetails = testSetUp.getServiceSetUpData("Name_InsertEmail");
					String InsertEmailReq = testSetUp.soapV5ReqAsString("InsertEmail_Prerequisite_01");
					InsertEmailReq = InsertEmailReq.replaceAll("Var_NameID", profileID1);
				
					emailOperaID = InsertEmail.createEmail(InsertEmailReq, reqDetails);
					System.out.println("emailOperaID " + emailOperaID);
					
					/*
					 *  Update Email
					 */
					WSClient.writeToReport(LogStatus.INFO, "Preparing to execute UpdateEmail operation");
					reqDetails = testSetUp.getServiceSetUpData("Name_UpdateEmail");
					...
					v5Req = v5Req.replaceAll("Var_nameEmailOperaId", emailOperaID);
