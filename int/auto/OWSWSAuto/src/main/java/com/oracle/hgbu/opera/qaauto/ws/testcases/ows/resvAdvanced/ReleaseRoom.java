...
//					WSClient.writeToReport(LogStatus.INFO, "<b>"+"-------------------------------------------------------"+"</b>");
					return false;
				}
		...
		//Release Room Sanity
		@Test(groups = { "sanity", "ResvAdvanced", "ReleaseRoomResvAdvanced", "OWS" })
	
		/* Method to check the RELEASE ROOM operation by passing Chain Code, Hotel Code, and Resv_Name_ID */
	
		public void releaseRoomResvAdvanced_38445() 
		{
			try 
			{
				String testName = "releaseRoomResvAdvanced_38445";
				...
				if (OperaPropConfig.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode", "PaymentMethod" })) 
				{
			        ...
			        if(!operaProfileID.equals("error")) 
			        {
							...
							/************
							 * Performing the Release Room
							 * operation
							 ****************/
							//Fetching Assigned room before releasing it
							String QS_01 = WSClient.getQuery("OWSResvAdvancedReleaseRoom", "QS_01");
		            		LinkedHashMap<String,String> dbDataMap=WSClient.getDBRow(QS_01);
						    String dbRoom = dbDataMap.get("ROOM");
						    WSClient.writeToReport(LogStatus.INFO, "<b>"+"Before releasing Room value in the DB is: "+dbRoom+"</b>");
...
//				            WSClient.writeToReport(LogStatus.INFO, "<b>"+"Releasing the Room"+"</b>");
							...
							String releaseRoomReq = WSClient.createSOAPMessage("OWSResvAdvancedReleaseRoom", "DS_01");
...
//						    WSClient.writeToReport(LogStatus.INFO, "<b>"+"Before releasing Room value in the DB is: "+dbRoom+"</b>");
							...
							if (WSAssert.assertIfElementExists(releaseRoomRes, "Result_Text_TextElement", true)) 
							{
								...
								String message = WSAssert.getElementValue(releaseRoomRes, "Result_Text_TextElement", XMLType.RESPONSE);
								WSClient.writeToReport(LogStatus.INFO, "<b>"+"The text displayed in the response is :" + message+"</b>");
							}
							
							//Checking For OperaErrorCode
							if (WSAssert.assertIfElementExists(releaseRoomRes,"ReleaseRoomAdvResponse_Result_OperaErrorCode", true)) 
							{
								String code = WSAssert.getElementValue(releaseRoomRes, "ReleaseRoomAdvResponse_Result_OperaErrorCode", XMLType.RESPONSE);
								WSClient.writeToReport(LogStatus.INFO, "<b>"+"The error code displayed in the response is :" + code+"</b>");
							}
							
							//Checking For Fault Schema
							if(WSAssert.assertIfElementExists(releaseRoomRes, "ReleaseRoomAdvResponse_faultcode", true))
							{
								String message=WSClient.getElementValue(releaseRoomRes,"ReleaseRoomAdvResponse_faultstring", XMLType.RESPONSE);
								WSClient.writeToReport(LogStatus.FAIL, "The Response has Fault Schema with message: "+message);
							}
							
							if (WSAssert.assertIfElementExists(releaseRoomRes, "ReleaseRoomAdvResponse_Result", false)) 
							{
								if (WSAssert.assertIfElementValueEquals(releaseRoomRes, "ReleaseRoomAdvResponse_Result_resultStatusFlag", "SUCCESS", false)) 
								{
				            		//Fetching ROOM number from DB (should be null when ROOM gets released)
								    ...
								    WSClient.writeToReport(LogStatus.INFO, "<b>"+"After releasing Room value in the DB is: "+dbRoomValue+"</b>");
								...
								if(WSAssert.assertIfElementExists(releaseRoomRes, "ReleaseRoomAdvResponse_Result_GDSError",true)) 
								{
									String message=WSAssert.getElementValue(releaseRoomRes, "ReleaseRoomAdvResponse_Result_GDSError", XMLType.RESPONSE);
									String errorCode = WSClient.getElementValue(releaseRoomRes, "ReleaseRoomAdvResponse_Result_GDSError_errorCode", XMLType.RESPONSE);
									String elementId = WSClient.getElementValue(releaseRoomRes, "ReleaseRoomAdvResponse_Result_GDSError_elementId", XMLType.RESPONSE);
									...
									{
										WSClient.writeToReport(LogStatus.INFO, "<b>"+"The errorCode is: "+errorCode+"</b>");
									}
									if(!((elementId.equals("")) || (elementId.equals("*null*"))))
									{
										WSClient.writeToReport(LogStatus.INFO, "<b>"+"The element ID is: "+elementId+"</b>");
									}
								}
							}
				...
				{
					WSClient.writeToReport(LogStatus.WARNING, "************Blocked :  prerequisites for RateCode or RoomType or SourceCode or MarketCode or PaymentMethod**********");
				}
			}
	        catch (Exception e) 
			{
		...
		//Release Room MR-1
		@Test(groups = { "minimumRegression", "ResvAdvanced", "ReleaseRoomResvAdvanced", "OWS" })
		
		/* Method to check the RELEASE ROOM operation by passing Chain Code, Resv_Name_ID , valid Resv_Name_ID type, and Invalid Hotel Code*/
	
		public void releaseRoomResvAdvanced_39393() 
		{
			try 
			{
				String testName = "releaseRoomResvAdvanced_39393";
				WSClient.startTest(testName, "Verify that the room is not released when an invalid HotelCode is passed", "minimumRegression");
				if (OperaPropConfig.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode", "PaymentMethod" })) 
				{
					// boolean prerequisite = true;
			        ...
			        if(!operaProfileID.equals("error")) 
			        {
				            ...
				            WSClient.writeToReport(LogStatus.INFO, "<b>"+"Releasing the Room"+"</b>");
				            WSClient.setData("{var_oresort}", owsresort);
							String releaseRoomReq = WSClient.createSOAPMessage("OWSResvAdvancedReleaseRoom", "DS_03");
							...
							{
								String code = WSAssert.getElementValue(releaseRoomRes, "ReleaseRoomAdvResponse_Result_OperaErrorCode", XMLType.RESPONSE);
								WSClient.writeToReport(LogStatus.INFO, "<b>"+"The error displayed in the response is :"+ code+"</b>");
							}
							else
							{
								WSClient.writeToReport(LogStatus.FAIL, "<b>"+"The OperaErrorCode is missing in the Response"+"</b>");
							}
							...
							if (WSAssert.assertIfElementExists(releaseRoomRes, "ReleaseRoomAdvResponse_Result", false)) 
							{
								if (WSAssert.assertIfElementValueEquals(releaseRoomRes, "ReleaseRoomAdvResponse_Result_resultStatusFlag", "FAIL", false)) 
								{
								...
								{
									WSClient.writeToReport(LogStatus.FAIL, "Resultstatus Flag populated as SUCCESS even with an invalid HotelCode!");
								}
		...
		/* Method to check the RELEASE ROOM operation by passing Chain Code, Hotel Code, Resv_Name_ID type, and Invalid Resv_Name_ID*/
	
		public void releaseRoomResvAdvanced_39394() 
		{
			try 
			{
				String testName = "releaseRoomResvAdvanced_39394";
				WSClient.startTest(testName, "Verify that the room is not released when an invalid Reservation NameID is passed", "minimumRegression");
				if (OperaPropConfig.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode", "PaymentMethod" })) 
				{
					// boolean prerequisite = true;
			        ...
			        if(!operaProfileID.equals("error")) 
			        {
				            ...
				            WSClient.writeToReport(LogStatus.INFO, "<b>"+"Releasing the Room"+"</b>");
				            WSClient.setData("{var_oresort}", owsresort);
							String releaseRoomReq = WSClient.createSOAPMessage("OWSResvAdvancedReleaseRoom", "DS_04");
							...
							if(WSAssert.assertIfElementExists(releaseRoomRes, "ReleaseRoomAdvResponse_faultcode", true))
							{
								String message=WSClient.getElementValue(releaseRoomRes,"ReleaseRoomAdvResponse_faultcode", XMLType.RESPONSE);
								WSClient.writeToReport(LogStatus.FAIL, "The Response has Fault Schema with message: "+message);
							}
							...
							if (WSAssert.assertIfElementExists(releaseRoomRes, "ReleaseRoomAdvResponse_Result", false)) 
							{
								...
								{
//									//Checking for GDSError
//									//In this Case of MR GDSError will contain the Message of what actually the Error is i.e. that Resv ID Doesnot exist
//									//Here, It is not the criterion for failing the Test Case so writing report as the INFO and not as FAIL
//									if(WSAssert.assertIfElementExists(releaseRoomRes, "ReleaseRoomAdvResponse_Result_GDSError",true)) 
//									{
//										String message=WSAssert.getElementValue(releaseRoomRes, "ReleaseRoomAdvResponse_Result_GDSError", XMLType.RESPONSE);
//																			
//										if(WSAssert.assertIfElementValueEquals(releaseRoomRes, "ReleaseRoomAdvResponse_Result_GDSError", "Reservation Does Not Exist, Unable To Change Room", true))
//										{
//											WSClient.writeToReport(LogStatus.PASS, "<b>"+"The error displayed is :"+ message+"</b>");
//										}
//										else
//										{
//											WSClient.writeToReport(LogStatus.FAIL, "<b>"+"The error does not Have message containing \"Reservation Does Not Exist\" "+"</b>");
//											WSClient.writeToReport(LogStatus.INFO, "<b>"+"The error displayed is :"+ message+"</b>");
//										}
//									}
//									else
//									{
...
//									}
								...
								{
									WSClient.writeToReport(LogStatus.FAIL, "Room Got Released even with the invalid Reservation ID");
								}
		...
		public void releaseRoomResvAdvanced_41504() 
		{
			String reservationId="";
			String reservationId1="";
			try 
			{
				String testName = "releaseRoomResvAdvanced_41504";
				WSClient.startTest(testName, "Verify that the room is released for a shared reservation", "minimumRegression");
				if (OperaPropConfig.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode", "PaymentMethod" })) 
				{
					// boolean prerequisite = true;
			        ...
			        if(!operaProfileID.equals("error")) 
			        {
							...
							if(!reservationId.equals("error"))
							{
								...
								if(!operaProfileID1.equals("error"))
								{
									...
									WSClient.writeToReport(LogStatus.INFO, "<b>"+"Reservation ID 2:- " + reservationId1+"</b>");
									if(!reservationId1.equals("error"))
									{
										...
										{
											WSClient.writeToReport(LogStatus.INFO, "<b>"+"Successfully combined the two reservations"+"</b>");
			...
			//						    		WSClient.writeToReport(LogStatus.INFO, "<b>"+"Releasing the Room"+"</b>");
									        ...
									        {
									        	WSClient.writeToReport(LogStatus.WARNING, "The prerequisites for Unique ID's failed!------ CombiningSharedReservation -----Blocked");
									        }
										
										}
										else
								        {
								        	WSClient.writeToReport(LogStatus.WARNING, "The prerequisites for Unique ID's failed!------ Create Reservation -----Blocked");
								        }
									}
									else
							        {
...
//							}
		...
		public void releaseRoomResvAdvanced_41505()
		{
			String reservationId="";
			try 
			{
				String testName = "releaseRoomResvAdvanced_41505";
				WSClient.startTest(testName, "Verify that the room is not released for a checked-in reservation", "minimumRegression");
				if (OperaPropConfig.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode", "PaymentMethod" })) 
				{
					// boolean prerequisite = true;
			        ...
			        if(!operaProfileID.equals("error")) 
			        {
							...
							if(!reservationId.equals("error"))
							{
								...
								if (WSAssert.assertIfElementExists(checkInRes, "CheckinReservationRS_Success", true)) 
								{
									...
									if (WSAssert.assertIfElementExists(releaseRoomRes, "ReleaseRoomAdvResponse_Result", false)) 
									{
										if (WSAssert.assertIfElementValueEquals(releaseRoomRes, "ReleaseRoomAdvResponse_Result_resultStatusFlag", "FAIL", false)) 
										{
						            		...
						            		//Verifying the DB Room Value is null or not 
										    WSClient.writeToReport(LogStatus.INFO, "<b>"+"After Release Room operation value in the DB is: "+dbRoomValue+"</b>");
										...
										{
											WSClient.writeToReport(LogStatus.FAIL, "Room Release should FAIL instead of passing!");
										}
						        ...
						        {
						        	WSClient.writeToReport(LogStatus.WARNING, "The prerequisites  failed!------ Checkin Reservation -----Blocked");
						        }
							}
							else
					        {
