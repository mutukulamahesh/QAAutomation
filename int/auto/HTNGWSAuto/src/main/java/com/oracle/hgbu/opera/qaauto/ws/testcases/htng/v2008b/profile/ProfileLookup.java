...
public class ProfileLookup extends WSSetUp {
	...
	@Test(groups = { "sanity", "ProfileLookUp", "HTNG2008B", "HTNG" })
	public void profileLookup_2008_4522() {
		try {
			String testName = "profileLookup_2008_4522";
			...
			OPERALib.setOperaHeader(uname);
					...
					//Prerequisite 2: Create Profile 2
							...
							String profileLookUpReq = WSClient.createSOAPMessage("HTNG2008ProfileLookUp", "DS_01");
	...
	@Test(groups = { "minimumRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
	public void profileLookup_2008_312() {
		try {
			String testName = "profileLookup_2008_312";
			WSClient.startTest(testName, "Verify firstname,middlename,lastname,profileid,nametitle"
					+ " is populated in the response", "minimumRegression");
			...
			OPERALib.setOperaHeader(uname);
					...
					//Validation request being created and processed to generate response
					HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
					String profileLookUpReq = WSClient.createSOAPMessage("HTNG2008ProfileLookUp", "DS_05");
					String profileLookUpResponseXML = WSClient.processSOAPMessage(profileLookUpReq);
	...
	/**
	 * @author psarawag 
	 * Description:Verify firstname,lastname,profileid is retreived when Wildcard search is performed on the First Name
	 */

	@Test(groups = { "minimumRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
	public void profileLookup_2008_307() {
		try {
			String testName = "profileLookup_2008_307";
			WSClient.startTest(testName, "Verify firstname,lastname,profileid are retreived when Wildcard search is performed on the First Name", "minimumRegression");
			String resortOperaValue = OPERALib.getResort();
			String interfaceName = HTNGLib.getHTNGInterface();
			String resortExtValue = HTNGLib.getExtResort(resortOperaValue,interfaceName);
			...
			OPERALib.setOperaHeader(uname);
					...
					//Prerequisite 2: Create Profile 2
							...
							//Prerequisite 3: Create Profile 3
									...
									//Validation request being created and processed to generate response
									HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
									String profileLookUpReq = WSClient.createSOAPMessage("HTNG2008ProfileLookUp",
											"DS_02");
									String profileLookUpResponseXML = WSClient.processSOAPMessage(profileLookUpReq);
	...
	@Test(groups = { "minimumRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
	public void profileLookup_2008_308() {
		try {

			String testName = "profileLookup_2008_308";
...
//			System.out.println("address_country :"+country_code);
			...
			OPERALib.setOperaHeader(uname);
					...
					//Prerequisite 2: Create Profile 2
							...
							//Validation request being created and processed to generate response
							HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
							String profileLookUpReq = WSClient.createSOAPMessage("HTNG2008ProfileLookUp", "DS_03");
							String profileLookUpResponseXML = WSClient.processSOAPMessage(profileLookUpReq);
	...
	@Test(groups = { "minimumRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
	public void profileLookup_2008_309() {
		try {
			String testName = "profileLookup_2008_309";
			...
			OPERALib.setOperaHeader(uname);
					...
					//Prerequisite 2: Create Profile 2
							...
							HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
							String profileLookUpReq = WSClient.createSOAPMessage("HTNG2008ProfileLookUp", "DS_04");
							String profileLookUpResponseXML = WSClient.processSOAPMessage(profileLookUpReq);
	...
	/**
	 * @author psarawag 
	 * Description: Verify that only primary Address is retrieved in the response
	 */

	@Test(groups = { "minimumRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
	public void profileLookup_2008_313() {
		try {
			String testName = "profileLookup_2008_313";
			WSClient.startTest(testName, "Verify that only primary Address is retrieved in the response", "minimumRegression");
			String prerequisite[]={"AddressType"};
			if(OperaPropConfig.getPropertyConfigResults(prerequisite)){
			String resortOperaValue = OPERALib.getResort();
			String interfaceName = HTNGLib.getHTNGInterface();
	...
	/**
	 * @author psarawag 
	 * Description: Verify that the PhoneNumber is populated in the response
	 */

	@Test(groups = { "minimumRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
	public void profileLookup_2008_314() {
		try {
			String testName = "profileLookup_2008_314";
			WSClient.startTest(testName, "Verify that the PhoneNumber is populated in the response", "minimumRegression");
...
//	/**
//	 * @author psarawag 
//	 * Description: Verify that the EmailId is populated in the response
//	 */
//
//	@Test(groups = { "minimumRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
//	public void profileLookup_2008_39340() {
//		try {
//			String testName = "profileLookup_2008_39340";
//			WSClient.startTest(testName, "Verify that the EmailId is populated in the response", "minimumRegression");
//			String prerequisite[]={"CommunicationType"};
//			if(OperaPropConfig.getPropertyConfigResults(prerequisite)){
//			
//			String resortOperaValue = OPERALib.getResort();
...
/**
 * @author psarawag 
 * Description: Verify only primary PhoneNumber is populated in the response
 */

@Test(groups = { "targetedRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
public void profileLookup_2008_316() {
	try {
		String testName = "profileLookup_2008_316";
		WSClient.startTest(testName, "Verify only primary PhoneNumber is populated in the response", "targetedRegression");
		String prerequisite[]={"CommunicationType"};
		if(OperaPropConfig.getPropertyConfigResults(prerequisite)){
		...
		WSClient.setData("{var_lname}", lname);
		WSClient.setData("{var_phoneType}", OperaPropConfig.getDataSetForCode("CommunicationType", "DS_01"));
		WSClient.setData("{var_phoneType2}", OperaPropConfig.getDataSetForCode("CommunicationType", "DS_03"));
		WSClient.setData("{var_emailType}", OperaPropConfig.getDataSetForCode("CommunicationType", "DS_02"));
		WSClient.setData("{var_email}", fname+"."+lname+"@oracle.com");
		//Prerequisite 1: Create Profile 1
		OPERALib.setOperaHeader(uname);

				String profileID = CreateProfile.createProfile("DS_48");
				if(!profileID.equals("error")){
					WSClient.writeToReport(LogStatus.INFO, "<b>ProfileId =" + profileID+"</b>");
				WSClient.setData("{var_profileID}", profileID);
				String query1=WSClient.getQuery("QS_04");
				...
				if (WSAssert.assertIfElementValueEquals(profileLookUpResponseXML,
					...
					//database records are being stored in a list of hashmaps
					String query2=WSClient.getQuery("QS_08");
					db = WSClient.getDBRow(query2);
...
@Test(groups = { "targetedRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
public void profileLookup_2008_310() {
	try {

		String testName = "profileLookup_2008_310";
		...
		OPERALib.setOperaHeader(uname);
				...
				//Prerequisite 2: Create Profile 2
						...
						//Validation request being created and processed to generate response
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String profileLookUpReq = WSClient.createSOAPMessage("HTNG2008ProfileLookUp", "DS_06");
						String profileLookUpResponseXML = WSClient.processSOAPMessage(profileLookUpReq);
...
@Test(groups = { "targetedRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
public void profileLookup_2008_311() {
	try {

		String testName = "profileLookup_2008_311";
...
//		System.out.println("address_country :"+country_code);
		...
		OPERALib.setOperaHeader(uname);
				...
				//Prerequisite 2: Create Profile 2
						...
						//Validation request being created and processed to generate response
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String profileLookUpReq = WSClient.createSOAPMessage("HTNG2008ProfileLookUp", "DS_07");
						String profileLookUpResponseXML = WSClient.processSOAPMessage(profileLookUpReq);
...
@Test(groups = { "targetedRegression", "ProfileLookup", "HTNG2008B", "HTNG" })
public void profileLookup_2008_319() {
	try {

		String testName = "profileLookup_2008_319";
...
@Test(groups = { "fullRegression", "ProfileLookUp", "HTNG2008B", "HTNG" })
public void profileLookup_2008_323() {
	try {
		String testName = "profileLookup_2008_323";
...
@Test(groups = { "minimumRegression", "ProfileLookUp", "HTNG2008B", "HTNG" })
public void profileLookup_2008_42602() {
	try {
		String testName = "profileLookup_2008_42602";
		...
		WSClient.setData("{var_chain}", OPERALib.getChain());
						...
						//Validation request being created and processed to generate response
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String profileLookUpReq = WSClient.createSOAPMessage("HTNG2008ProfileLookUp", "DS_08");
						String profileLookUpResponseXML = WSClient.processSOAPMessage(profileLookUpReq);
