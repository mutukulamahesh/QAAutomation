...
public class UpdateActivity extends WSSetUp {
	...
	@Test(groups = { "sanity", "UpdateActivity", "HTNG2006", "HTNG" })
	public void updateActivity_2006_20419() {
		try {
			String testName = "updateActivity_2006_20419";
			WSClient.startTest(testName,
					"verify that the ProfileID is updated correctly through the UpdateActivity call for an existing ActivityID.",
					"sanity");
			...
			String activityLocExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
					"ACTIVITY_LOCATION");
			String activityStatusExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
					"ACTIVITY_STATUS");
			...
			if (!operaProfileID.equals("error")) {
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes, "SubscriptionResponse_Result_resultStatusFlag",
					...
					if (WSAssert.assertIfElementValueEquals(createActRes,
						...
						if (WSAssert.assertIfElementExists(createActRes, "Results_IDs_UniqueID", true)) {
							...
							if (!operaNewProfileID.equals("error")) {
								...
								HTNGLib.setHTNGHeader(OPERALib.getUserName(), OPERALib.getPassword(),
										HTNGLib.getInterfaceFromAddress());
								String updateActReq = WSClient.createSOAPMessage("HTNG2006UpdateActivity", "DS_01");
								...
								if (WSAssert.assertIfElementValueEquals(updateActRes,
									...
									HashMap<String, String> profileDetails = WSClient
											.getDBRow(WSClient.getQuery("QS_01"));
									HashMap<String, String> activityDetails = WSClient
									...
									if (WSAssert.assertEquals(operaNewProfileID, profileDetails.get("PROFILE_ID"),
										...
										WSClient.writeToReport(LogStatus.PASS, "Profile_Id is populated as expected");
									...
									if (WSAssert
											.assertEquals(activityTypeExtValue,
													HTNGLib.getExtValue(resortOperaValue, interfaceName,
															"ACTIVITY_TYPE", profileDetails.get("ACTIVITY_TYPE")),
													true)) {
									...
									if (WSAssert
											.assertEquals(activityLocExtValue,
													HTNGLib.getExtValue(resortOperaValue, interfaceName,
															"ACTIVITY_LOCATION", activityDetails.get("LOCATION_CODE")),
													true)) {
										...
										WSClient.writeToReport(LogStatus.FAIL, "Location is not populated as expected");
										WSClient.writeToReport(LogStatus.INFO,
												"Expected: " + activityLocExtValue + " Actual: "
														+ HTNGLib.getExtValue(resortOperaValue, interfaceName,
																"ACTIVITY_LOCATION",
									...
									if (WSAssert
											.assertEquals(activityStatusExtValue,
													HTNGLib.getExtValue(resortOperaValue, interfaceName,
															"ACTIVITY_STATUS", activityDetails.get("STATUS_CODE")),
													true)) {
					...
					WSClient.writeToReport(LogStatus.WARNING,
							"************Blocked : Subscription not created***************");
				}
	...
	// @Test(groups = { "minimumRegression", "UpdateActivity","HTNG2006", "HTNG"
	// })

	public void updateActivity_2006_20406() {
		try {
			String testName = "updateActivity_2006_20406";
			WSClient.startTest(testName,
					"Verify that the ReservationID is updated correctly through the UpdateActivity call for an existing ActivityID.",
					"minimumRegression");
							...
							if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
								...
								if (WSAssert.assertIfElementExists(createNewProfileResponseXML,
									...
									if (WSAssert.assertIfElementExists(createNewProfileResponseXML,
										...
										// Create Reservation
										WSClient.setData("{var_profileId}", operaNewProfileID);
										String newReservationId = CreateReservation.createReservation("DS_05")
												.get("reservationId");
										if (!reservationId.equals("error")) {
											...
											String updateActReq = WSClient.createSOAPMessage("HTNG2006UpdateActivity",
													"DS_02");
											String updateActRes = WSClient.processSOAPMessage(updateActReq);
											...
											if (WSAssert.assertIfElementValueEquals(updateActRes,
												...
												HashMap<String, String> reservDetails = WSClient
														.getDBRow(WSClient.getQuery("QS_03"));
										...
										WSClient.writeToReport(LogStatus.WARNING,
												"Prerequisite failed >> Profile is not created");
									}
								}
	...
	@Test(groups = { "minimumRegression", "UpdateActivity", "HTNG2006", "HTNG","updateActivity_2006_20405" })
	public void updateActivity_2006_20405() {
		try {
			String testName = "updateActivity_2006_20405";
			WSClient.startTest(testName,
					"Verify that the ActivityStatus,ActivityType, Location are updated correctly for an activity using ProfileID.",
					"minimumRegression");
			...
			String activityTypeExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName, "ACTIVITY_TYPE");
			System.out.print(activityTypeExtValue);
			String activityLocExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
					"ACTIVITY_LOCATION");
			System.out.print(activityLocExtValue);
			String activityStatusExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
					"ACTIVITY_STATUS");
			System.out.print(activityStatusExtValue);
			String genderExtValue = HTNGLib.getRandomPMSValue(resortOperaValue, interfaceName, "GENDER_MF");
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes, "SubscriptionResponse_Result_resultStatusFlag",
					...
					if (WSAssert.assertIfElementValueEquals(createActRes,
						...
						if (WSAssert.assertIfElementExists(createActRes, "Results_IDs_UniqueID", true)) {
							 ...
							 * Main Operation: Update Activity
							 ****************/
							activityTypeExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
									"ACTIVITY_TYPE");
							activityLocExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
									"ACTIVITY_LOCATION");
							activityStatusExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
									"ACTIVITY_STATUS");
							...
							HTNGLib.setHTNGHeader(OPERALib.getUserName(), OPERALib.getPassword(),
									HTNGLib.getInterfaceFromAddress());
							String updateActReq = WSClient.createSOAPMessage("HTNG2006UpdateActivity", "DS_03");
							String updateActRes = WSClient.processSOAPMessage(updateActReq);
							...
							if (WSAssert.assertIfElementValueEquals(updateActRes,
								...
								if (WSAssert.assertEquals(activityTypeExtValue, HTNGLib.getExtValue(resortOperaValue,
										interfaceName, "ACTIVITY_TYPE", profileDetails.get("ACTIVITY_TYPE")), true)) {

									WSClient.writeToReport(LogStatus.PASS, "Activity Type is populated as expected");
									WSClient.writeToReport(LogStatus.INFO, "Expected: "
											+ activityTypeExtValue + " Actual: " + HTNGLib.getExtValue(resortOperaValue,
													interfaceName, "ACTIVITY_TYPE", profileDetails.get("ACTIVITY_TYPE"))
											+ "");
								} else {
								...
								if (WSAssert.assertEquals(activityStatusExtValue, HTNGLib.getExtValue(resortOperaValue,
										interfaceName, "ACTIVITY_STATUS", activityDetails.get("STATUS_CODE")), true)) {

									WSClient.writeToReport(LogStatus.PASS, "Activity Status is populated as expected");
									WSClient.writeToReport(LogStatus.INFO,
											"Expected: " + activityStatusExtValue + " Actual: "
													+ HTNGLib.getExtValue(resortOperaValue, interfaceName,
															"ACTIVITY_STATUS", activityDetails.get("STATUS_CODE"))
	...
	@Test(groups = { "minimumRegression", "UpdateActivity", "HTNG2006", "HTNG" })
	public void updateActivity_2006_20408() {
		try {
			String testName = "updateActivity_2006_20408";
			WSClient.startTest(testName,
					"Verify that the NumberOfPersons,notes, Amount, DepositeRequired and DepositRequired/collectedBy of an activity are updated correctly for the requested profileID.",
					"minimumRegression");
			...
			if (OperaPropConfig
				...
				String activityTypeExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
						"ACTIVITY_TYPE");
				String activityLocExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
						"ACTIVITY_LOCATION");
				String activityStatusExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
...

					{
						...
						if (WSAssert.assertIfElementValueEquals(createActRes,
							...
							if (WSAssert.assertIfElementExists(createActRes, "Results_IDs_UniqueID", true)) {
								...
								String updateActReq = WSClient.createSOAPMessage("HTNG2006UpdateActivity", "DS_04");
								String updateActRes = WSClient.processSOAPMessage(updateActReq);
								...
								if (WSAssert.assertIfElementValueEquals(updateActRes,
									...
									HashMap<String, String> activityDetails = WSClient
											.getDBRow(WSClient.getQuery("QS_04"));
									...
									WSClient.writeToReport(LogStatus.INFO, "Expected: " + numberOfPersons + " Actual: "
											+ activityDetails.get("NOP") + "");

									if (WSAssert.assertEquals(sampleNotes, activityDetails.get("NOTES"), true)) {

										WSClient.writeToReport(LogStatus.PASS, "Notes is updated as expected");
									} else {

										WSClient.writeToReport(LogStatus.FAIL, "Notes is not updated as expected");
									}
									WSClient.writeToReport(LogStatus.INFO, "Expected: " + sampleNotes + " Actual: "
									...
									WSClient.writeToReport(LogStatus.INFO, "Expected: " + amount + " Actual: "
											+ activityDetails.get("ACTIVITY_AMOUNT") + "");

									if (WSAssert.assertEquals(depositeAmount, activityDetails.get("DEPOSIT_AMOUNT"),
											true)) {
									...
									WSClient.writeToReport(LogStatus.INFO, "Expected: " + depositeAmount + " Actual: "
	...
	@Test(groups = { "targetedRegression", "UpdateActivity", "HTNG2006", "HTNG","updateActivity_2006_20407" })
	public void updateActivity_2006_20407() {
		try {
			String testName = "updateActivity_2006_20407";
			WSClient.startTest(testName,
					"verify that the Verify multiple activities can updated for the requested ProfileID.",
					"targetedRegression");
			String resortOperaValue = OPERALib.getResort();
			String interfaceName = HTNGLib.getHTNGInterface();
			String resortExtValue = HTNGLib.getExtResort(resortOperaValue, interfaceName);
			...
			String activityTypeExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName, "ACTIVITY_TYPE");
			System.out.println(activityTypeExtValue);
			String activityLocExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
					"ACTIVITY_LOCATION");
			String activityStatusExtValue = HTNGLib.getRandomExtValue(resortOperaValue, interfaceName,
					"ACTIVITY_STATUS");
								...
								if (WSAssert.assertIfElementExists(createActRes1, "Results_IDs_UniqueID", true)) {
									...
									if (!operaNewProfileID.equals("error")) {
										...
										if (WSAssert.assertIfElementValueEquals(updateActRes,
											...
											if (WSAssert.assertEquals(WSClient.getElementValueByIndex(updateActRes,
													xpathValues, XMLType.RESPONSE), "SUCCESS", true)) {

												WSClient.writeToReport(LogStatus.PASS,
														"Second Success Flag -> Expected : SUCCESS, Actual : "
																+ WSClient.getElementValueByIndex(updateActRes,
																		xpathValues, XMLType.RESPONSE));
												...
												if (WSAssert.assertEquals(operaNewProfileID,
														profileDetails.get("PROFILE_ID"), true)) {

													WSClient.writeToReport(LogStatus.PASS,
															"Profile_Id is populated as expected");
													WSClient.writeToReport(LogStatus.INFO,
															"Expected: " + operaNewProfileID + " Actual: "
																	+ profileDetails.get("PROFILE_ID") + "");
												} else {
												...
												if (WSAssert.assertEquals(activityTypeExtValue,
														HTNGLib.getExtValue(resortOperaValue, interfaceName,
																"ACTIVITY_TYPE", profileDetails.get("ACTIVITY_TYPE")),
														true)) {
												...
												if (WSAssert.assertEquals(activityLocExtValue,
														HTNGLib.getExtValue(resortOperaValue, interfaceName,
																"ACTIVITY_LOCATION",
																activityDetails.get("LOCATION_CODE")),
														true)) {
													...
													WSClient.writeToReport(LogStatus.PASS,
															"Location is populated as expected");
													WSClient.writeToReport(LogStatus.INFO,
															"Expected: " + activityLocExtValue + " Actual: "
																	+ HTNGLib.getExtValue(resortOperaValue,
												...
												if (WSAssert.assertEquals(activityStatusExtValue,
														HTNGLib.getExtValue(resortOperaValue, interfaceName,
																"ACTIVITY_STATUS", activityDetails.get("STATUS_CODE")),
														true)) {
	...
	@Test(groups = { "fullRegression", "UpdateActivity", "HTNG2006", "HTNG" })
	public void updateActivity_2006_20410() {
		try {
			String testName = "updateActivity_2006_20410";
			WSClient.startTest(testName,
					"verify that the Error Message is Populated when an Invalid Activity Status is passed on the request.",
					"fullRegression");
			String resortOperaValue = OPERALib.getResort();
			String interfaceName = HTNGLib.getHTNGInterface();
			String resortExtValue = HTNGLib.getExtResort(resortOperaValue, interfaceName);
						...
						if (WSAssert.assertIfElementExists(createActRes, "Results_IDs_UniqueID", true)) {
							...
							if (!operaNewProfileID.equals("error")) {
								...
								if (WSAssert.assertIfElementValueEquals(updateActRes,
									...
									WSAssert.assertIfElementValueEquals(updateActRes, "Results_Text_TextElement",
											"{INVALID_STATUS_CODE}--INVALID ACTIVITY STATUS CODE", false);
	...
	@Test(groups = { "fullRegression", "UpdateActivity", "HTNG2006", "HTNG" })
	public void updateActivity_2006_42690() {
		try {
			String testName = "updateActivity_2006_42690";
			WSClient.startTest(testName,
					"verify that the Error Message is Populated when an Invalid Activity Type is passed on the request.",
					"fullRegression");
			String resortOperaValue = OPERALib.getResort();
			String interfaceName = HTNGLib.getHTNGInterface();
			String resortExtValue = HTNGLib.getExtResort(resortOperaValue, interfaceName);
					...
					if (WSAssert.assertIfElementValueEquals(createActRes,
						...
						if (WSAssert.assertIfElementExists(createActRes, "Results_IDs_UniqueID", true)) {
							...
							if (!operaNewProfileID.equals("error")) {
								...
								String inavalidData = "INVALID_ACTIVITY_TYPE"
										+ String.valueOf(new Random().nextInt(1000) + 1);

								WSClient.setData("{var_activityType}", inavalidData);

								WSClient.writeToReport(LogStatus.INFO,
										"<b>Invalid Activity Type : " + inavalidData + "</b>");
								...
								if (WSAssert.assertIfElementValueEquals(updateActRes,
									...
									WSAssert.assertIfElementValueEquals(updateActRes, "Results_Text_TextElement",
											"{INVALID_ACTIVITY_TYPE}--INVALID ACTIVITY TYPE", false);
	...
	@Test(groups = { "fullRegression", "UpdateActivity", "HTNG2006", "HTNG" })
	public void updateActivity_2006_42691() {
		try {
			String testName = "updateActivity_2006_42691";
			WSClient.startTest(testName,
					"verify that the Error Message is Populated when an Invalid Activity Location Code is passed on the request.",
					"fullRegression");
			String resortOperaValue = OPERALib.getResort();
			String interfaceName = HTNGLib.getHTNGInterface();
			String resortExtValue = HTNGLib.getExtResort(resortOperaValue, interfaceName);
					...
					if (WSAssert.assertIfElementValueEquals(createActRes,
						...
						if (WSAssert.assertIfElementExists(createActRes, "Results_IDs_UniqueID", true)) {
							...
							if (!operaNewProfileID.equals("error")) {
								...
								String inavalidData = "INVALID_ACTIVITY_LOCATION"
										+ String.valueOf(new Random().nextInt(1000) + 1);

								WSClient.setData("{var_activityLocation}", inavalidData);

								WSClient.writeToReport(LogStatus.INFO,
										"<b>Invalid Activity Location Code : " + inavalidData + "</b>");
								...
								if (WSAssert.assertIfElementValueEquals(updateActRes,
									...
									WSAssert.assertIfElementValueEquals(updateActRes, "Results_Text_TextElement",
											"{INVALID_LOCATION_CODE}--INVALID LOCATION CODE", false);
	...
	@Test(groups = { "fullRegression", "UpdateActivity", "HTNG2006", "HTNG" })
	public void updateActivity_2006_20411() {
		try {
			String testName = "updateActivity_2006_20411";
			WSClient.startTest(testName,
					"verify that the Error Message is Populated when a Resort Id is not passed on the request.",
					"fullRegression");
			String resortOperaValue = OPERALib.getResort();
			String interfaceName = HTNGLib.getHTNGInterface();
			String resortExtValue = HTNGLib.getExtResort(resortOperaValue, interfaceName);
						...
						if (WSAssert.assertIfElementExists(createActRes, "Results_IDs_UniqueID", true)) {
							...
							if (!operaNewProfileID.equals("error")) {
								...
								if (WSAssert.assertIfElementValueEquals(updateActRes,
									...
									WSClient.writeToReport(LogStatus.INFO, WSClient.getElementValue(updateActRes,
											"Results_Text_TextElement", XMLType.RESPONSE));
	...
	@Test(groups = { "fullRegression", "UpdateActivity", "HTNG2006", "HTNG" })
	public void updateActivity_2006_20412() {
		try {
			String testName = "updateActivity_2006_20412";
			WSClient.startTest(testName,
					"verify that the Error Message is Populated when an Invalid Resort Id is passed on the request.",
					"fullRegression");
			String resortOperaValue = OPERALib.getResort();
			String interfaceName = HTNGLib.getHTNGInterface();
			String resortExtValue = HTNGLib.getExtResort(resortOperaValue, interfaceName);
					...
					if (WSAssert.assertIfElementValueEquals(createActRes,
						...
						if (WSAssert.assertIfElementExists(createActRes, "Results_IDs_UniqueID", true)) {
							...
							if (!operaNewProfileID.equals("error")) {
								 ...
								 * Main Operation: Update Activity
								 ****************/
								String inavalidData = "INVALID_RESORT_ID"
										+ String.valueOf(new Random().nextInt(1000) + 1);

								WSClient.setData("{var_extResort}", inavalidData);

								WSClient.writeToReport(LogStatus.INFO,
										"<b>Invalid Resort Id : " + inavalidData + "</b>");
	...
	public void updateActivity_2006_20413() {
		try {
			String testName = "updateActivity_2006_20413";
			WSClient.startTest(testName,
					"Verify that the Error Message is Populated when trying to update the activity with Cancelled ReservationID.",
					"fullRegression");
									...
									if (WSAssert.assertIfElementExists(createNewProfileResponseXML,
										...
										if (!reservationId.equals("error")) {
											...
											if (CancelReservation.cancelReservation("DS_02")) {
												...
												String updateActReq = WSClient
														.createSOAPMessage("HTNG2006UpdateActivity", "DS_02");
												String updateActRes = WSClient.processSOAPMessage(updateActReq);
												...
												if (WSAssert.assertIfElementValueEquals(updateActRes,
													...
													WSClient.writeToReport(LogStatus.INFO,
															"<b>" + WSClient.getElementValue(updateActRes,
																	"Results_Text_TextElement", XMLType.RESPONSE)
															+ "</b>");
