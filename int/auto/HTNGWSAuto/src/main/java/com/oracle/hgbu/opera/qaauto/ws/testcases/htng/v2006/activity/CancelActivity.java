...
public class CancelActivity extends WSSetUp {
	...
	@Test(groups = { "sanity", "CancelActivity", "HTNG2006", "HTNG" })
	 ...
	 *****/
	public void cancelActivity_2006_20403() {
		try {
			String testName = "cancelActivity_2006_20403";
			...
			if (!operaProfileID.equals("error")) {
				...
				if (WSAssert.assertIfElementExists(subscriptionRes, "SubscriptionResponse_Result", true)) {
					if (WSAssert.assertIfElementValueEquals(subscriptionRes, "SubscriptionResponse_Result_resultStatusFlag", "SUCCESS", true)) {
						...
						String createActXML = WSClient.createSOAPMessage("HTNG2006CreateActivity", "DS_01");
						...
						if (WSAssert.assertIfElementValueEquals(createActRes, "CreateActivityResponse_Results_resultStatusFlag", "SUCCESS", true)) {
							...
							if (WSAssert.assertIfElementExists(createActRes, "Results_IDs_UniqueID", true)) {
								...
								String cancelActXML = WSClient.createSOAPMessage("HTNG2006CancelActivity", "DS_01");
	...
	@Test(groups = { "minimumRegression", "CancelActivity", "HTNG2006", "HTNG" })
	/*****
	...
	public void cancelActivity_2006_20404() {
		try {
			String testName = "cancelActivity_2006_20404";
							...
							if (WSAssert.assertIfElementExists(createActRes, "Results_IDs_UniqueID", true)) {
								...
								if (WSAssert.assertIfElementExists(cancelActRes, "CancelActivityResponse_Results", true)) {
									if (WSAssert.assertIfElementValueEquals(cancelActRes, "CancelActivityResponse_Results_resultStatusFlag", "SUCCESS", true)) {
										...
										String cancelActivityXML = WSClient.createSOAPMessage("HTNG2006CancelActivity", "DS_01");
	...
	public void cancelActivity_2006_20401() {
		/*****
		...
		try {
			...
			String testName = "cancelActivity_2006_20401";
			...
			String cancelActXML = WSClient.createSOAPMessage("HTNG2006CancelActivity", "DS_02");
			String cancelActRes = WSClient.processSOAPMessage(cancelActXML);
	...
	@Test(groups = { "targetedRegression", "CancelActivity", "HTNG2006", "HTNG" })
	public void cancelActivity_2006_20402() {
		...
		try {
			...
			String testName = "cancelActivity_2006_20402";
			...
			String cancelActXML = WSClient.createSOAPMessage("HTNG2006CancelActivity", "DS_03");
			String cancelActRes = WSClient.processSOAPMessage(cancelActXML);
