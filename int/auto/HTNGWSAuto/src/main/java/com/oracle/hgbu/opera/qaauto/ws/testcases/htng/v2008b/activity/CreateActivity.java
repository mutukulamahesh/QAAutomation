...
public class CreateActivity extends WSSetUp {
	...
	@Test(groups = { "sanity", "CreateActivity", "HTNG2008B", "HTNG" })

	public void createActivity_2008_4518() {
		try {
			String testName = "createActivity_2008_4518";
	...
	@Test(groups = { "minimumRegression", "Create Activity", "HTNG2008B", "HTNG" })

	public void createActivity_2008_3090() {
		try {
			String testName = "createActivity_2008_3090";
	...
	public void createActivity_2008_3092() {
		try {
			String testName = "createActivity_2008_3092";
			...
			if(!profileID.equals("error"))
			{
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes,
					...
					//**************HTNG Create Activity**********************//
					HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
					String createActivityReq = WSClient.createSOAPMessage("HTNG2008CreateActivity", "DS_03");
					String createActivityResponseXML = WSClient.processSOAPMessage(createActivityReq);
					if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
							"CreateActivityResponse_Results_resultStatusFlag", "SUCCESS", false)) {
	...
	public void createActivity_2008_3097() {
		try {
			String testName = "createActivity_2008_3097";
	...
	public void createActivity_2008_3101() {
		try {
			String testName = "createActivity_2008_3101";
			...
			if(!profileID.equals("error"))
			{
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes,
					...
					if(!resvID.equals("error"))
					{
						...
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String createActivityReq = WSClient.createSOAPMessage("HTNG2008CreateActivity", "DS_05");
						String createActivityResponseXML = WSClient.processSOAPMessage(createActivityReq);
	...
	@Test(groups = { "targetedRegression", "CreateActivity", "HTNG2008B", "HTNG" })

	public void createActivity_2008_3093() {
		try {
			String testName = "createActivity_2008_3093";
			...
			if(!profileID.equals("error"))
			{
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes,
					...
					//************HTNG Create Activity*************************//
					HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
					String createActivityReq = WSClient.createSOAPMessage("HTNG2008CreateActivity", "DS_06");
					String createActivityResponseXML = WSClient.processSOAPMessage(createActivityReq);
	...
	@Test(groups = { "fullRegression", "CreateActivity", "HTNG2008B", "HTNG" })

	public void createActivity_2008_3095() {
		try {
			String testName = "createActivity_2008_3095";
	...
	//@Test(groups = { "minimumRegression", "CreateActivity", "HTNG2008B", "HTNG" })
	//
	//public void createActivity_2008_20401() {
	//	try {
	//		String testName = "createActivity_2008_20401";
	...
	public void createActivity_2008_3102() {
		try {
			String testName = "createActivity_2008_3102";
	...
	@Test(groups = { "targetedRegression", "Create Activity", "HTNG2008B", "HTNG" })

	public void createActivity_2008_3098() {
		try {
			String testName = "createActivity_2008_3098";
			...
			if (OperaPropConfig.getPropertyConfigResults(new String[] { "ResvCancelReason" })) {
				...
				WSClient.setData("{var_resvId}",WSClient.getDBRow(WSClient.getQuery("HTNG2008CreateActivity","QS_10")).get("RESV_NAME_ID"));
