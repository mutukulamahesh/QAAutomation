...
public class GuestMessage extends WSSetUp {
	...
	@Test(groups = { "sanity", "GuestMessage", "HTNG2006", "HTNG" })
	public void guestMessage_2006_21844() {
		try {
			String testName = "guestMessage_2006_21844";
			WSClient.startTest(testName, "Verify if the message is submitted to the reservation sent on the request",
					"sanity");
			if (OperaPropConfig
				...
				if (!operaProfileID.equals("error")) {
					...
					if (!reservationId.equals("error")) {
						...
						String guestMessageReq = WSClient.createSOAPMessage("HTNG2006GuestMessage", "DS_01");
						...
						if (WSAssert.assertIfElementExists(guestMessageResponse, "GuestMessageResponse_Result",
							...
							if (WSAssert.assertIfElementValueEquals(guestMessageResponse,
								...
								/*
								 * HashMap<String, String> res_values = new
								 * HashMap<>(); res_values.put(
								 * "GuestMessageRequest_ReservationID",
								 * "GuestMessageRequest_ReservationID");
								 * res_values.put("GuestMessageRequest_Message",
								 * "GuestMessageRequest_Message");
								 */

								LinkedHashMap<String, String> resResult = new LinkedHashMap<String, String>();
								resResult.put("ReservationID1", WSClient.getElementValue(guestMessageReq,
										"GuestMessageRequest_ReservationID", XMLType.REQUEST));
								resResult.put("Message1", WSClient.getElementValue(guestMessageReq,
										"GuestMessageRequest_Message", XMLType.REQUEST));
					...
					WSClient.writeToReport(LogStatus.WARNING,
							"---- Prerequisite createProfile Blocked ----\nRate UniqueID not received!");
				}
	...
	@Test(groups = { "minimumRegression", "guestMessage", "HTNG2006", "HTNG","guestMessage_2006_20478" })
	public void guestMessage_2006_20478() {
		try {
			String testName = "guestMessage_2006_20478";
			...
			if (!operaProfileID.equals("error")) {
				...
				if (!reservationId.equals("error")) {
					...
					WSClient.setData("{var_profileId}", operaProfileID);
					HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
					String guestMessageReq = WSClient.createSOAPMessage("HTNG2006GuestMessage", "DS_02");
					String guestMessageResponse = WSClient.processSOAPMessage(guestMessageReq);
					...
					if (WSAssert.assertIfElementExists(guestMessageResponse, "GuestMessageResponse_Result", false)) {
						if (WSAssert.assertIfElementValueEquals(guestMessageResponse,
							...
							resResult.put("Message1", WSClient.getElementValue(guestMessageReq,
									"GuestMessageRequest_Message", XMLType.REQUEST));
							resResult.put("From1", WSClient.getElementValue(guestMessageReq, "GuestMessageRequest_From",
									XMLType.REQUEST));							
	...
	@Test(groups = { "minimumRegression", "guestMessage", "HTNG2006", "HTNG" })
	public void guestMessage_2006_20482() {
		try {
			String testName = "guestMessage_2006_20482";
			WSClient.startTest(testName,
			...
			if (!operaProfileID.equals("error")) {
				...
				if (!reservationId.equals("error")) {
					...
					WSClient.setData("{var_extResort}", resortExtValue);
					HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
					String guestMessageReq = WSClient.createSOAPMessage("HTNG2006GuestMessage", "DS_03");
					String guestMessageResponse = WSClient.processSOAPMessage(guestMessageReq);
					...
					if (WSAssert.assertIfElementExists(guestMessageResponse, "GuestMessageResponse_Result", false)) {
						if (WSAssert.assertIfElementValueEquals(guestMessageResponse,
							 ...
							 */
							LinkedHashMap<String, String> resResult = new LinkedHashMap<String, String>();
							resResult.put("<b>ReservationID1</b>", WSClient.getElementValue(guestMessageReq,
									"GuestMessageRequest_ReservationID", XMLType.REQUEST));
							resResult.put("<b>Message1</b>", WSClient.getElementValue(guestMessageReq,
									"GuestMessageRequest_Message", XMLType.REQUEST));
	...
	/**
	 * @author heegupta Description: Verifying the GuestMessageReponse when
	 *         reservationID, From & Contact details are provided in the
	 *         GuestMessageRequest
	 * 
	 */
	@Test(groups = { "fullRegression", "GuestMessage", "HTNG2006", "HTNG" })
	public void guestMessage_2006_20477() {
		try {
			String testName = "guestMessage_2006_20477";
			WSClient.startTest(testName,
					"Verifying the GuestMessageReponse when reservationID, From & Contact details are provided in the GuestMessageRequest",
					"fullRegression");
			if (OperaPropConfig
					.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode" })) {
				String resortOperaValue = OPERALib.getResort();
				...
				if (!operaProfileID.equals("error")) {
					...
					if (!reservationId.equals("error")) {
						...
						// HTNG Guest Message
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String guestMessageReq = WSClient.createSOAPMessage("HTNG2006GuestMessage", "DS_04");
						String guestMessageResponse = WSClient.processSOAPMessage(guestMessageReq);

						if (WSAssert.assertIfElementExists(guestMessageResponse, "GuestMessageResponse_Result",
								false)) {
							if (WSAssert.assertIfElementValueEquals(guestMessageResponse,
									"GuestMessageResponse_Result_resultStatusFlag", "FAIL", false)) {
						...
						WSClient.writeToReport(LogStatus.WARNING,
								"---- Prerequisite createReservation Blocked ----Reservation is not created");
					}
				} else {
					WSClient.writeToReport(LogStatus.WARNING,
							"---- Prerequisite createProfile Blocked ----Profile is not created");
				}
			} else {
				WSClient.writeToReport(LogStatus.WARNING,
						"---- Prerequisite for \"RateCode\", \"RoomType\", \"SourceCode\", \"MarketCode\" blocked");
			}
		} catch (Exception e) {
			WSClient.writeToReport(LogStatus.ERROR, "Exception occured in test due to:" + e);
		} finally {
	 ...
	 */
	@Test(groups = { "fullRegression", "GuestMessage", "HTNG2006", "HTNG" })
	public void guestMessage_2006_42822() {
		try {
			String testName = "guestMessage_2006_42822";
			WSClient.startTest(testName,
					"Verify the error message in the repsonse when reservation Id is missed in the request",
					"fullRegression");
			if (OperaPropConfig
					.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode" })) {
				String resortOperaValue = OPERALib.getResort();
				...
				if (!operaProfileID.equals("error")) {
					...
					// HTNG Guest Message
					HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
					String guestMessageReq = WSClient.createSOAPMessage("HTNG2006GuestMessage", "DS_05");
					String guestMessageResponse = WSClient.processSOAPMessage(guestMessageReq);
	...
	/**
	 * @author heegupta Description: Verifying the GuestMessage response for a
	 *         CANCELLED reservation.
	 */

	@Test(groups = { "fullRegression", "GuestMessage", "HTNG2006", "HTNG" })
	public void guestMessage_2006_20476() {
		try {
			String testName = "guestMessage_2006_20476";
			WSClient.startTest(testName, "Verifying the GuestMessage response for a CANCELLED reservation",
					"fullRegression");
			if (OperaPropConfig
					.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode" })) {
				String resortOperaValue = OPERALib.getResort();
				...
				if (!operaProfileID.equals("error")) {
					...
					if (!reservationId.equals("error")) {
						...
						// HTNG Guest Message
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String guestMessageReq = WSClient.createSOAPMessage("HTNG2006GuestMessage", "DS_06");
						String guestMessageResponse = WSClient.processSOAPMessage(guestMessageReq);
	...
	@Test(groups = { "fullRegression", "GuestMessage", "HTNG2006", "HTNG" })
	public void guestMessage_2006_42823() {
		try {
			String testName = "guestMessage_2006_42823";
			WSClient.startTest(testName,
					"Verifying the GuestMessageResponse when only reservationID is passed on the GuestMessageRequest.",
					"fullRegression");
			if (OperaPropConfig
					.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode" })) {
				String resortOperaValue = OPERALib.getResort();
				...
				if (!operaProfileID.equals("error")) {
					...
					if (!reservationId.equals("error")) {
						...
						// HTNG Guest Message
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String guestMessageReq = WSClient.createSOAPMessage("HTNG2006GuestMessage", "DS_07");
						String guestMessageResponse = WSClient.processSOAPMessage(guestMessageReq);
	...
	/**
	 * @author heegupta Description: Verifying the GuestMessageResponse when
	 *         invalid reservationID, valid From, Contact & Message details are
	 *         provided in the GuestMessageRequest
	 */

	@Test(groups = { "fullRegression", "GuestMessage", "HTNG2006", "HTNG" })
	public void guestMessage_2006_20483() {
		try {
			String testName = "guestMessage_2006_20483";
			WSClient.startTest(testName,
					"Verifying the GuestMessageResponse when invalid reservationID, valid From, Contact & Message details are provided in the GuestMessageRequest",
					"fullRegression");
			if (OperaPropConfig
					.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode" })) {
				String resortOperaValue = OPERALib.getResort();
				...
				if (!operaProfileID.equals("error")) {
					...
					if (!reservationId.equals("error")) {
						WSClient.writeToReport(LogStatus.INFO,
								"<b>Taking some invalid Reservation Id: " + reservationId + "</b>");
						WSClient.setData("{var_resvId}", reservationId);
						WSClient.setData("{var_confirmationId}", confirmationId);
						WSClient.setData("{var_extResort}", resortExtValue);
	...
	/**
	 * @author heegupta Description: Verify GuestMessageResposne when only From
	 *         details are provided in the GuestMessageRequest.
	 */
	@Test(groups = { "fullRegression", "GuestMessage", "HTNG2006", "HTNG" })
	public void guestMessage_2006_20479() {
		try {
			String testName = "guestMessage_2006_20479";
			WSClient.startTest(testName,
					"Verify GuestMessageResposne when only From details are provided in the GuestMessageRequest.",
					"fullRegression");
			if (OperaPropConfig
					.getPropertyConfigResults(new String[] { "RateCode", "RoomType", "SourceCode", "MarketCode" })) {
				String resortOperaValue = OPERALib.getResort();
				...
				if (!operaProfileID.equals("error")) {
					...
					// HTNG Guest Message
					HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
					String guestMessageReq = WSClient.createSOAPMessage("HTNG2006GuestMessage", "DS_08");
					String guestMessageResponse = WSClient.processSOAPMessage(guestMessageReq);
