package com.oracle.hgbu.opera.qaauto.ws.testcases.htng.v2006.activitysync;
...
public class LocationNotification extends WSSetUp {
	...
	@Test(groups = { "sanity", "LocationNotification","HTNG2006","HTNG","locationNotification_2006_20498" })
	public void locationNotification_2006_20498() {
		try {
			String testName = "locationNotification_2006_20498";
			...
			/************ Prerequisite 1: Create Profile ****************/
					...
					/******** Prerequisite 5: Create Reservation **************/
						...
						String CreateLocationNotificationnReq = WSClient
								.createSOAPMessage("HTNG2006LocationNotification", "DS_01");
	...
	@Test(groups = { "minimumRegression", "LocationNotification","HTNG2006","HTNG" })
	public void locationNotification_2006_20495() {
		try {
			String testName = "locationNotification_2006_20495";
			...
			/******** Prerequisite 5: Create Reservation **************/
				...
				if(!reservationId.equals("reservationId")){
					...
					WSClient.setData("{var_resvId}", reservationId);
						...
						HTNGLib.setHTNGHeader(OPERALib.getUserName(), OPERALib.getPassword(), HTNGLib.getInterfaceFromAddress());
						String CreateLocationNotificationnReq = WSClient
								.createSOAPMessage("HTNG2006LocationNotification", "DS_02");
						String CreateLocationNotificationnRes = WSClient
								.processSOAPMessage(CreateLocationNotificationnReq);
	...
	@Test(groups = { "fullRegression", "LocationNotification","HTNG2006","HTNG" })
	public void locationNotification_2006_20496() {
		try {
			String testName = "locationNotification_2006_20496";
			...
			WSClient.setData("{var_resvID}", WSClient.getDBRow(WSClient.getQuery("HTNG2006LocationNotification", "QS_03")).get("INVALID_RESVID"));
	...
	@Test(groups = { "fullRegression", "LocationNotification","HTNG2006","HTNG" })
	public void locationNotification_2006_20497() {
		try {
			String testName = "locationNotification_2006_20497";
