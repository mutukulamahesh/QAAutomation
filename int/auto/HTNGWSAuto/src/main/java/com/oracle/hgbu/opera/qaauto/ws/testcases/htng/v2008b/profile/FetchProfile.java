...
public class FetchProfile extends WSSetUp {
	...
	@Test(groups = { "sanity", "FetchProfile", "HTNG2008B", "HTNG", "BAT","fetchProfile_2008_4519"})
	/*****
	 * Fetching the profile and validating first name, last name, name type
	 *****/
	/***** Prerequisite : Creating a profile *****/
	public void fetchProfile_2008_4519() {
		try {
			String testName = "fetchProfile_2008_4519";
			// boolean prerequisite_block_flag = true;
			WSClient.startTest(testName,
					"Verify that the First Name, Last Name and Profile Type are retrieved onto the response", "sanity");
			...
			if (!operaProfileID.equals("error")) {
				...
				String fetchProfileReq = WSClient.createSOAPMessage("HTNG2008FetchProfile", "DS_01");
				...
				if (WSAssert.assertIfElementValueEquals(fetchProfileResponseXML,
					...
					String first = WSClient.getElementValue(fetchProfileResponseXML, "Customer_PersonName_FirstName",
							XMLType.RESPONSE);
					String sname = WSClient.getElementValue(fetchProfileResponseXML, "Customer_PersonName_LastName",
							XMLType.RESPONSE);
					String nameType = WSClient.getElementValue(fetchProfileResponseXML,
							"FetchProfileResponse_Profile_nameType", XMLType.RESPONSE);
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_38821() {
		try {
			String testName = "fetchProfile_2008_38821";
			WSClient.startTest(testName, "Verify the Address of the profile that are retrieved onto the response",
					"minimumRegression");
				...
				if (!operaProfileID.equals("error")) {
					...
					if (addressid.size()>0) {
						...
						if (WSAssert.assertIfElementValueEquals(fetchProfileResponseXML,
							...
							// hashmaps
							actualValues = WSClient.getSingleNodeList(fetchProfileResponseXML, xPath, false,
									XMLType.RESPONSE);
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_140() {
		try {
			String testName = "fetchProfile_2008_140";
			WSClient.startTest(testName,
					"Verify the multiple Addresses of the profile that are retrieved onto the response",
					"minimumRegression");
					...
					if (addressid.size()>0) {
						...
						if (WSAssert.assertIfElementExists(changeProfileResponseXML, "ChangeProfileRS_Success", true)) {
							if (WSAssert.assertIfElementExists(changeProfileResponseXML,
								...
								WSClient.writeToReport(LogStatus.INFO, "<b>Second Address is added to the Profile</b>");
								...
								if (WSAssert.assertIfElementValueEquals(fetchProfileResponseXML,
									...
									// database records are being stored in a
									// list of hashmaps
									...
									xPath.put("Profile_Addresses_NameAddress_addressType",
											"Profile_Addresses_NameAddress");

									// response records are being stored in a
									// list of hashmaps
								...
								if (WSAssert.assertIfElementExists(fetchProfileResponseXML, "Result_Text_TextElement",
										true)) {
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_147() {
		try {
			String testName = "fetchProfile_2008_147";
			WSClient.startTest(testName,
			...
			if (OperaPropConfig.getPropertyConfigResults(prerequisites)) {
					...
					if (commentId.size()>0) {
						...
						if (WSAssert.assertIfElementValueEquals(fetchProfileResponseXML,
							...
							if (WSAssert.assertIfElementExists(fetchProfileResponseXML,
								...
								// response
								String commentText = WSClient.getElementValue(fetchProfileResponseXML,
				...
				WSClient.writeToReport(LogStatus.WARNING, "The prerequisites for comment Type failed -----Blocked");
			}
		} catch (Exception e) {
			WSClient.writeToReport(LogStatus.ERROR, "Exception occured in test due to:" + e);
		} finally {
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_144() {
		try {
			String testName = "fetchProfile_2008_144";
			WSClient.startTest(testName,
					"Verify that the Comments are being retrieved correctly when the FetchProfile call is issued"
							+ " with a valid Profile Identifier",
					"minimumRegression");
			String[] prerequisites = { "NoteType" };
			if (OperaPropConfig.getPropertyConfigResults(prerequisites)) {
				String resortOperaValue = OPERALib.getResort();
				...
				if (!operaProfileID.equals("error")) {
					...
					String query1 = WSClient.getQuery("QS_05");
					LinkedHashMap<String, String> commentId = WSClient.getDBRow(query1);
					if (commentId.size() >= 2) {
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_4397() {
		try {
			String testName = "fetchProfile_2008_4397";
			WSClient.startTest(testName,
					"Verify that the customer demographics and document details are being retrieved correctly "
							+ "when the FetchProfile call is issued with a valid Profile Identifier",
					"minimumRegression");
			if(OperaPropConfig.getPropertyConfigResults(new String [] {"IdentificationType","Title","VipLevel"})){
				...
				if(!operaProfileID.equals("error")){
					...
					if (WSAssert.assertIfElementExists(changeProfileResponseXML, "ChangeProfileRS_Success", true)) {
						WSClient.writeToReport(LogStatus.INFO, "<b>Identification ID is attached to the Profile</b>");
						String query1 = WSClient.getQuery("QS_01");
						HashMap<String,String> documentId = WSClient.getDBRow(query1);
						...
						if (documentId.size()>0) {
							...
							if (WSAssert.assertIfElementValueEquals(fetchProfileResponseXML,
								...
								xPath.put("GovernmentIDList_GovernmentID_DocumentType",
										"Customer_GovernmentIDList_GovernmentID");
								//								xPath.put("GovernmentIDList_GovernmentID_DocumentNumber",
								//										"Customer_GovernmentIDList_GovernmentID");
								xPath.put("GovernmentIDList_GovernmentID_EffectiveDate",
										"Customer_GovernmentIDList_GovernmentID");
								xPath.put("GovernmentIDList_GovernmentID_CountryOfIssue",
										"Customer_GovernmentIDList_GovernmentID");
								// xPath.put("FetchProfileResponse_Profile_Customer_gender","FetchProfileResponse_Profile_Customer");
								//								xPath.put("FetchProfileResponse_Profile_Customer_birthDate",
								//										"FetchProfileResponse_Profile_Customer");
								...
								//									actualValues.put("birthDate1",
								//											"XXXXXX" + birthDate.substring(birthDate.length() - 2));
								//								}
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_38827() {
		try {
			String testName = "fetchProfile_2008_38827";
			WSClient.startTest(testName,
					"Verify that the emailID information is being retrieved correctly when the FetchProfile call "
							+ "is issued with a valid Profile Identifier",
					"minimumRegression");
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_141() {
		try {
			String testName = "fetchProfile_2008_141";
			WSClient.startTest(testName,
					"Verify that the phone information is being retrieved correctly when the FetchProfile call "
							+ "is issued with a valid Profile Identifier",
					"minimumRegression");
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_148() {
		try {
			String testName = "fetchProfile_2008_148";
			WSClient.startTest(testName, "Verify the privacy options that are retrieved onto the response",
					"minimumRegression");
			...
			if(!operaProfileID.equals("error")){
				...
				if (WSAssert.assertIfElementValueEquals(fetchProfileResponseXML,
					...
					// Validation points are being fetched from the response
					String mailValue = WSClient.getElementValueByAttribute(fetchProfileResponseXML,
							"Profile_PrivacyList_PrivacyOption_OptionValue",
							"Profile_PrivacyList_PrivacyOption_OptionType", "MAIL", XMLType.RESPONSE);
					String emailValue = WSClient.getElementValueByAttribute(fetchProfileResponseXML,
							"Profile_PrivacyList_PrivacyOption_OptionValue",
							"Profile_PrivacyList_PrivacyOption_OptionType", "EMAIL", XMLType.RESPONSE);
					...
					String query1 = WSClient.getQuery("QS_03");
					dbValues = WSClient.getDBRow(query1);
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_143() {
		try {
			String testName = "fetchProfile_2008_143";
			...
			if (OperaPropConfig.getPropertyConfigResults(prerequisites)) {
				...
				if(!operaProfileID.equals("error")){
					...
					String query1 = WSClient.getQuery("HTNG2008FetchProfile", "QS_10");
					...
					if (WSAssert.assertIfElementExists(createPreferenceResponseXML, "CreatePreferenceRS_Success",
							true)) {
				...
				WSClient.writeToReport(LogStatus.WARNING,
						"The prerequisites for Preference Type and Preference Value Failed!");
			}
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_38829() {
		try {
			String testName = "fetchProfile_2008_38829";
			WSClient.startTest(testName,
					"Verify that the Membership Information is being retrieved correctly when the FetchProfile"
							+ " call is issued with a valid Profile Identifier",
					"minimumRegression");
			...
			if(OperaPropConfig.getPropertyConfigResults(prerequisites)){
				...
				if(!operaProfileID.equals("error")){
					...
					if (WSAssert.assertIfElementExists(createMembershipResponseXML, "CreateMembershipRS_Success",
							true)) {

						if (WSAssert.assertIfElementExists(createMembershipResponseXML,
								"CreateMembershipRS_ProfileMemberships_ProfileMembership_MembershipID", true)) {
							...
							if (WSAssert.assertIfElementValueEquals(fetchProfileResponseXML,
								...
								xPath.put("Memberships_NameMembership_MembershipLevel",
										"Profile_Memberships_NameMembership");
								xPath.put("Memberships_NameMembership_MemberName",
										"Profile_Memberships_NameMembership");
								xPath.put("Memberships_NameMembership_EffectiveDate",
										"Profile_Memberships_NameMembership");
								xPath.put("Memberships_NameMembership_ExpirationDate",
										"Profile_Memberships_NameMembership");
								xPath.put("Profile_Memberships_NameMembership_inactiveDate",
										"Profile_Memberships_NameMembership");
							...
							WSClient.writeToReport(LogStatus.WARNING,
									"The prerequisites for MembershipNo!---- Create Membership  Failed!- -----Blocked");
						}
					} else {
						WSClient.writeToReport(LogStatus.WARNING,
								"The prerequisites for Create Membership  Failed!- -----Blocked");
					}
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_145() {
		try {
			String testName = "fetchProfile_2008_145";
			WSClient.startTest(testName,
					"Verify that multiple Memberships Information are being retrieved correctly when the FetchProfile"
							+ " call is issued with a valid Profile Identifier",
					"minimumRegression");
			String[] prerequisites={"MembershipType","MembershipLevel"};
			if(OperaPropConfig.getPropertyConfigResults(prerequisites)){
						...
						if (WSAssert.assertIfElementExists(createMembershipResponseXML,
							...
							if (WSAssert.assertIfElementExists(createMembershipResponseXML,
								...
								if (WSAssert.assertIfElementExists(createMembershipResponseXML,
									...
									// processed to generate response
									HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
									String fetchProfileReq = WSClient.createSOAPMessage("HTNG2008FetchProfile",
											"DS_01");
									String fetchProfileResponseXML = WSClient.processSOAPMessage(fetchProfileReq);
									...
									if (WSAssert.assertIfElementValueEquals(fetchProfileResponseXML,
										...
										// a list of hashmaps
										actualValues = WSClient.getMultipleNodeList(fetchProfileResponseXML, xPath,
	...
	@Test(groups = { "minimumRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_39325() {
		try {
			String testName = "fetchProfile_2008_39325";
	...
	@Test(groups = { "fullRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_149() {
		try {
			String testName = "fetchProfile_2008_149";
			...
			fetchProfileReq = WSClient.createSOAPMessage("HTNG2008FetchProfile", "DS_01");
	...
	@Test(groups = { "fullRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_150() {
		try {
			String testName = "fetchProfile_2008_150";
			...
			// generate response
			HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
			String fetchProfileReq = WSClient.createSOAPMessage("HTNG2008FetchProfile", "DS_02");
			String fetchProfileResponseXML = WSClient.processSOAPMessage(fetchProfileReq);
	...
	@Test(groups = { "fullRegression", "FetchProfile", "HTNG2008B", "HTNG" })
	public void fetchProfile_2008_155() {
		try {
			String testName = "fetchProfile_2008_155";
