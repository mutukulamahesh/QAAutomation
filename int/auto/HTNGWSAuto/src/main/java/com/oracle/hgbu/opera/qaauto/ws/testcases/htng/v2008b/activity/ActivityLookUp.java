...
public class ActivityLookUp extends WSSetUp {
	...
	@Test(groups = { "sanity", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_4535() {
		try {
			String testName = "activityLookUp_2008_4535";
			...
			if (!operaProfileID.equals("error")) {
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes, "SubscriptionResponse_Result_resultStatusFlag",
					...
					String createActivityReq = WSClient.createSOAPMessage("HTNG2008CreateActivity", "DS_01");
					...
					if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
						...
						WSClient.setData("{var_actlocation}",
								HTNGLib.getRandomExtValue(resortOperaValue, interfaceName, "ACTIVITY_LOCATION"));
						String createActivityReq_2 = WSClient.createSOAPMessage("HTNG2008CreateActivity", "DS_01");
						...
						if (WSAssert.assertIfElementValueEquals(createActivityResponseXML_2,
							...
							// Activity Look Up
							String req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_01");
	...
	@Test(groups = { "minimumRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3202() {
		try {
			String testName = "activityLookUp_2008_3202";
			WSClient.startTest(testName,
	...
	@Test(groups = { "minimumRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3203() {
		try {
			String testName = "activityLookUp_2008_3203";
			WSClient.startTest(testName,
	...
	@Test(groups = { "minimumRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3204() {
		try {
			String testName = "activityLookUp_2008_3204";
			WSClient.startTest(testName,
	...
	/* @author ketvaidy */
	@Test(groups = { "minimumRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3222() {
		try {
			String testName = "activityLookUp_2008_3222";
			WSClient.startTest(testName,
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes, "SubscriptionResponse_Result_resultStatusFlag",
					...
					if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
						...
						if (WSAssert.assertIfElementValueEquals(createActivityResponseXML_2,
							...
							// Activity Look Up
							String req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_02");
							String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
							if (WSAssert.assertIfElementExists(res_activityLookUp, "Result_Text_TextElement", true)) {
								String text = WSClient.getElementValue(res_activityLookUp, "Result_Text_TextElement",
										XMLType.RESPONSE);
							...
							if (WSAssert.assertIfElementValueEquals(res_activityLookUp,
									"ActivityLookupResponse_Result_resultStatusFlag", "SUCCESS", false)) {
								String startDate = WSClient.getElementValue(req_activityLookUp,
										"Activity_TimeSpan_Start", XMLType.REQUEST);
	...
	/* @author ketvaidy */
	@Test(groups = { "minimumRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3223() {
		try {
			String testName = "activityLookUp_2008_3223";
			WSClient.startTest(testName,
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes, "SubscriptionResponse_Result_resultStatusFlag",
					...
					if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
						...
						if (WSAssert.assertIfElementValueEquals(createActivityResponseXML_2,
							...
							if (WSAssert.assertIfElementValueEquals(res_activityLookUp,
									"ActivityLookupResponse_Result_resultStatusFlag", "SUCCESS", false)) {
								String startDate = WSClient.getElementValue(req_activityLookUp, "Activity_TimeSpan_End",
										XMLType.REQUEST);
								WSClient.setData("{var_date}", startDate);
	...
	/* @author nkamired */
	@Test(groups = { "minimumRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3213() {
		try {
			String testName = "activityLookUp_2008_3213";
			WSClient.startTest(testName,
					"Verify that the Address details of the guest for which the scheduled activities are requested is correctly returned by the Activity Look-up call",
					"minimumRegression");
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes, "SubscriptionResponse_Result_resultStatusFlag",
					...
					if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
						...
						if (WSAssert.assertIfElementValueEquals(createActivityResponseXML_2,
							...
							// Activity Look Up
							String req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_05");
							String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
							if (WSAssert.assertIfElementExists(res_activityLookUp, "Result_Text_TextElement", true)) {
								String text = WSClient.getElementValue(res_activityLookUp, "Result_Text_TextElement",
										XMLType.RESPONSE);
	...
	/* @author nilsaini */
	@Test(groups = { "minimumRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3206() {
		try {
			String testName = "activityLookUp_2008_3206";
			WSClient.startTest(testName,
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
							...
							if (WSAssert.assertIfElementValueEquals(createActivityResponseXML_2,
								...
								// Activity Look Up
								String req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup",
										"DS_04");
								String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
	...
	public void activityLookUp_2008_3205() {
		try {
			String testName = "activityLookUp_2008_3205";
			WSClient.startTest(testName,
					"Verify that only the primary address is being returned onto the response message via Activity look-up call though the requested profile has more than one address records",
					"minimumRegression");
						...
						if (WSAssert.assertIfElementExists(changeProfileResponseXML, "ChangeProfileRS_Success",
							...
							if (WSAssert.assertIfElementExists(changeProfileResponseXML,
								...
								if (WSAssert.assertIfElementValueEquals(subscriptionRes,
									...
									String createActivityReq = WSClient.createSOAPMessage("HTNG2008CreateActivity",
											"DS_01");
									String createActivityResponseXML = WSClient.processSOAPMessage(createActivityReq);
									if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
											"CreateActivityResponse_Results_resultStatusFlag", "SUCCESS", true)) {
										...
										if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
											...
											String req_activityLookUp = WSClient
													.createSOAPMessage("HTNG2008ActivityLookup", "DS_01");
											String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
											if (WSAssert.assertIfElementExists(res_activityLookUp,
	...
	@Test(groups = { "targetedRegression", "ActivityLookUp", "HTNG2008B", "HTNG", "activityLookUp_2008_3208" })
	public void activityLookUp_2008_3208() {
		try {
			String testName = "activityLookUp_2008_3208";
			WSClient.startTest(testName,
			...
			WSClient.setData("{var_lname}", lname);
			String operaProfileID = CreateProfile.createProfile("DS_06");// 2204465802
			WSClient.writeToReport(LogStatus.INFO, "<b>Profile Id: " + operaProfileID + "</b>");
			if (!operaProfileID.equals("error")) {
				WSClient.setData("{var_profileID}", operaProfileID);
				WSClient.setData("{var_E_profileID}", WSClient.getKeywordData("{KEYWORD_RANDNUM_5}"));
	...
	@Test(groups = { "targetedRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3207() {
		try {
			String testName = "activityLookUp_2008_3207";
			WSClient.startTest(testName,
	...
	@Test(groups = { "targetedRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3209() {
		try {
			String testName = "activityLookUp_2008_3209";
			WSClient.startTest(testName,
					...
					if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
						...
						if (dbResult3.size() > 0) {
							...
							if (!operaProfileID.equals("error")) {
								...
								// Response
								subscriptionReq = WSClient.createSOAPMessage("HTNG2008Subscription", "DS_01");
								...
								if (WSAssert.assertIfElementValueEquals(subscriptionRes,
									...
									createActivityReq = WSClient.createSOAPMessage("HTNG2008CreateActivity", "DS_01");
									...
									if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
										...
										if (dbResult.size() > 0) {
											...
											// Activity Look Up
											String req_activityLookUp = WSClient
													.createSOAPMessage("HTNG2008ActivityLookup", "DS_13");
											String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
											if (WSAssert.assertIfElementExists(res_activityLookUp,
													"Result_Text_TextElement", true)) {
												String text = WSClient.getElementValue(res_activityLookUp,
	...
	@Test(groups = { "targetedRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3220() {
		try {
			String testName = "activityLookUp_2008_3220";
			WSClient.startTest(testName,
	...
	@Test(groups = { "targetedRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3212() {
		try {
			String testName = "activityLookUp_2008_3212";
			WSClient.startTest(testName,
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes, "SubscriptionResponse_Result_resultStatusFlag",
					...
					if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
						...
						if (WSAssert.assertIfElementValueEquals(createActivityResponseXML_2,
							...
							dbResult = WSClient.getDBRows(WSClient.getQuery("HTNG2008ActivityLookup", "QS_15"));
							if (dbResult.isEmpty()) {
								WSClient.writeToReport(LogStatus.WARNING, "<b>Problem with creating activities</b>");
							} else {

								WSClient.writeToReport(LogStatus.INFO, "<b>Two Activities Created for the profile</b>");
								...
								if (WSAssert.assertIfElementValueEquals(res_activityLookUp,
									...
									List<LinkedHashMap<String, String>> resResult = WSAssert.getMultipleNodeList(
											res_activityLookUp, res_values, false, XMLType.RESPONSE);
	...
	@Test(groups = { "targetedRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3221() {
		try {
			String testName = "activityLookUp_2008_3221";
			WSClient.startTest(testName,
				...
				if (WSAssert.assertIfElementValueEquals(subscriptionRes, "SubscriptionResponse_Result_resultStatusFlag",
					...
					if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
						...
						if (WSAssert.assertIfElementValueEquals(createActivityResponseXML_2,
							...
							// Activity Look Up
							String req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_07");
							String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
	...
	@Test(groups = { "targetedRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3210() {
		try {
			String testName = "activityLookUp_2008_3210";
			WSClient.startTest(testName,
								...
								if (WSAssert.assertIfElementValueEquals(subscriptionRes,
									...
									if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
										...
										if (dbResult.size() > 0) {
											...
											// Activity Look Up
											String req_activityLookUp = WSClient
													.createSOAPMessage("HTNG2008ActivityLookup", "DS_15");
											String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
											if (WSAssert.assertIfElementExists(res_activityLookUp,
													"Result_Text_TextElement", true)) {
												String text = WSClient.getElementValue(res_activityLookUp,
	...
	@Test(groups = { "targetedRegression", "ActivityLookUp", "HTNG2008B", "HTNG" })
	public void activityLookUp_2008_3211() {
		try {
			String testName = "activityLookUp_2008_3211";
			WSClient.startTest(testName,
								...
								if (WSAssert.assertIfElementValueEquals(subscriptionRes,
									...
									if (WSAssert.assertIfElementValueEquals(createActivityResponseXML,
										...
										if (dbResult.size() > 0) {
											...
											// Activity Look Up
											String req_activityLookUp = WSClient
													.createSOAPMessage("HTNG2008ActivityLookup", "DS_16");
											String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
											if (WSAssert.assertIfElementExists(res_activityLookUp,
													"Result_Text_TextElement", true)) {
												String text = WSClient.getElementValue(res_activityLookUp,
	...
	@Test(groups = { "fullRegression", "ActivityLookUp", "HTNG2008", "HTNG" })
	public void activityLookUp_2008_3215() {
		try {
			String testName = "activityLookUp_2008_3215";
			WSClient.startTest(testName,
			...
			if (!operaProfileID.equals("error")) {
				...
				WSClient.setData("{var_profileID}", WSClient
						.getDBRow(WSClient.getQuery("HTNG2008ActivityLookup", "QS_11")).get("PROFILE").toString());
				...
				WSClient.writeToReport(LogStatus.INFO,
						"<b>Verify if error exists when profileId is not passed in the response</b>");
				req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_01");
	...
	@Test(groups = { "fullRegression", "ActivityLookUp", "HTNG2008", "HTNG" })
	public void activityLookUp_2008_3216() {
		try {
			String testName = "activityLookUp_2008_3216";
			WSClient.startTest(testName,
			...
			if (!operaProfileID.equals("error")) {
				...
				WSClient.setData("{var_addressType}", OperaPropConfig.getDataSetForCode("AddressType", "DS_01"));
				// Activity Look Up
				String req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_04");
				String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
				WSAssert.assertIfElementValueEquals(res_activityLookUp,
						"ActivityLookupResponse_Result_resultStatusFlag", "FAIL", false);
				WSClient.setData("{var_lname}", lName);
				...
				WSClient.writeToReport(LogStatus.INFO,
						"<b>Verify if error exists when resort is not passed in the response</b>");
				req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_04");
				res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
				WSAssert.assertIfElementValueEquals(res_activityLookUp,
						"ActivityLookupResponse_Result_resultStatusFlag", "FAIL", false);
	...
	@Test(groups = { "fullRegression", "ActivityLookUp", "HTNG2008", "HTNG" })
	public void activityLookUp_2008_3217() {
		try {
			String testName = "activityLookUp_2008_3217";
			WSClient.startTest(testName,
			...
			if (!operaProfileID.equals("error")) {
				...
				String req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_09");
				String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
				WSAssert.assertIfElementValueEquals(res_activityLookUp,
						"ActivityLookupResponse_Result_resultStatusFlag", "FAIL", false);
	...
	@Test(groups = { "fullRegression", "ActivityLookUp", "HTNG2008", "HTNG" })
	public void activityLookUp_2008_3219() {
		try {
			String testName = "activityLookUp_2008_3219";
			WSClient.startTest(testName,
			...
			if (!operaProfileID.equals("error")) {
				...
				String req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_10");
				String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
				WSAssert.assertIfElementValueEquals(res_activityLookUp,
						"ActivityLookupResponse_Result_resultStatusFlag", "FAIL", false);
	...
	@Test(groups = { "fullRegression", "ActivityLookUp", "HTNG2008", "HTNG" })
	public void activityLookUp_2008_3218() {
		try {
			String testName = "activityLookUp_2008_3218";
			WSClient.startTest(testName,
					"Verify that an error message is returned onto the response message when the activity look-up call is submitted with the Address that is not associated to the guest having the given last name",
					"fullRegression");
			...
			if (!operaProfileID.equals("error")) {
				...
				WSClient.writeToReport(LogStatus.INFO,
						"<b>Verify error exists when invalid city is passed on the request</b>");
				String req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_12");
				String res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
				WSAssert.assertIfElementValueEquals(res_activityLookUp,
						"ActivityLookupResponse_Result_resultStatusFlag", "FAIL", false);
				if (WSAssert.assertIfElementExists(res_activityLookUp, "Result_Text_TextElement", true)) {
				...
				WSClient.writeToReport(LogStatus.INFO,
						"Verify that the error exists when invalid state is passed on the request");
				req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_12");
				res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
				WSAssert.assertIfElementValueEquals(res_activityLookUp,
						"ActivityLookupResponse_Result_resultStatusFlag", "FAIL", false);
				if (WSAssert.assertIfElementExists(res_activityLookUp, "Result_Text_TextElement", true)) {
				...
				WSClient.writeToReport(LogStatus.INFO,
						"Verify that the error exists when invalid zip is passed on the request");
				req_activityLookUp = WSClient.createSOAPMessage("HTNG2008ActivityLookup", "DS_12");
				res_activityLookUp = WSClient.processSOAPMessage(req_activityLookUp);
				WSAssert.assertIfElementValueEquals(res_activityLookUp,
						"ActivityLookupResponse_Result_resultStatusFlag", "FAIL", false);
