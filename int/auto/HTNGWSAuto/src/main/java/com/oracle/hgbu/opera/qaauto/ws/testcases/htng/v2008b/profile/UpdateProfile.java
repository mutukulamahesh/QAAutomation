...
public class UpdateProfile extends WSSetUp {
	...
	@Test(groups = { "sanity", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_4531() {
		try {
			String testName = "updateProfile_2008_4531";
            ...
            OPERALib.setOperaHeader(uname);
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_01");
	...
	@Test(groups = { "minimumRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1902() {
		try {
			String testName = "updateProfile_2008_1902";
			WSClient.startTest(testName,
			...
			//Prerequisite 1: Create Profile
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						WSClient.setData("{var_city}", addLOV.get("City"));
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_02");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "minimumRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_40641() {
		try {
			String testName = "updateProfile_2008_40641";
			WSClient.startTest(testName,
	...
	@Test(groups = { "minimumRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1911() {
		try {
			String testName = "updateProfile_2008_1911";
			WSClient.startTest(testName,
			...
			WSClient.setData("{var_commentType}", OperaPropConfig.getDataSetForCode("NoteType", "DS_01"));
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
							"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS", true)) {
						WSClient.writeToReport(LogStatus.INFO, "<b>ExtProfileId =" + extProfileID+"</b>");
						comment=WSClient.getKeywordData("{KEYWORD_RANDSTR_10}");
						...
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_03");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"minimumRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1918() {
		try {
			String testName = "updateProfile_2008_1918";
			...
			WSClient.setData("{var_phoneType}",OperaPropConfig.getDataSetForCode("CommunicationType", "DS_01"));
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
						...
						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_04");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"minimumRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1915() {
		try {
			String testName = "updateProfile_2008_1915";
			...
			WSClient.setData("{var_phoneType}",OperaPropConfig.getDataSetForCode("CommunicationType", "DS_01"));
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
						...
						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_05");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"minimumRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1921() {
		try {
			String testName = "updateProfile_2008_1921";
			...
			OPERALib.setOperaHeader(uname);
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
						...
						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_06");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"minimumRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1925() {
		try {
			String testName = "updateProfile_2008_1925";
			WSClient.startTest(testName, "Verify that all the guest privacy options (PRIVACY, EMAIL and PHONE) are updated with to the submitted "
					+ "information through UpdateProfile call for the requested existing profile", "minimumRegression");
			...
			OPERALib.setOperaHeader(uname);
					...
					String UniqueId = CreateProfile.createProfile("DS_05");
					if(!UniqueId.equals("error")){
	    			WSClient.writeToReport(LogStatus.INFO, "<b>ProfileId ="+UniqueId+"</b>");
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
						WSClient.writeToReport(LogStatus.INFO, "<b>ExtProfileId =" + extProfileID+"</b>");
						WSClient.setData("{var_privType}", "MAIL");
						WSClient.setData("{var_privValue}", "NO");
						WSClient.setData("{var_privType2}", "EMAIL");
						WSClient.setData("{var_privValue2}", "NO");
						
						
						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_08");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
		            	...
		            	if(WSAssert.assertIfElementValueEquals(updateProfileResponseXML,"UpdateProfileResponse_Result_resultStatusFlag","SUCCESS",false)) {  
		                    ...
		                    String mailValue=WSClient.getElementValueByAttribute(updateProfileReq, "Profile_PrivacyList_PrivacyOption_OptionValue", "Profile_PrivacyList_PrivacyOption_OptionType", "MAIL", XMLType.REQUEST);
							String emailValue=WSClient.getElementValueByAttribute(updateProfileReq, "Profile_PrivacyList_PrivacyOption_OptionValue", "Profile_PrivacyList_PrivacyOption_OptionType", "EMAIL", XMLType.REQUEST);
		         				
							actualValues.put("MAIL_LIST",mailValue);
							actualValues.put("EMAIL_YN",emailValue);
							actualValues.put("GUEST_PRIV_YN","NO");
...
//	@Test(groups= {"minimumRegression","UpdateProfile","HTNG2008B","HTNG"})
//	public void updateProfile_2008_1932() {
//		try {
//			String testName = "updateProfile_2008_1932";
...
//						
//						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_09");
//		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
//		            	
//		            	if(WSAssert.assertIfElementValueEquals(updateProfileResponseXML,"UpdateProfileResponse_Result_resultStatusFlag","SUCCESS",false)) {  
//		            		LinkedHashMap<String,String> db=new LinkedHashMap<String,String>();
...
//	}
	@Test(groups = { "minimumRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1935() {
		try {
			String testName = "updateProfile_2008_1935";
			WSClient.startTest(testName,
			...
			WSClient.setData("{var_addressType}", OperaPropConfig.getDataSetForCode("AddressType", "DS_01"));
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						WSClient.setData("{var_city}", addLOV.get("City"));
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_10");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "minimumRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1936() {
		try {
			String testName = "updateProfile_2008_1936";
			WSClient.startTest(testName,
					"Verify that the Country Code associated to the existing address record is updated/overriden with the Default"
					+ " Country Code that is configured in the Interface Parameters through the UpdateProfile call",
					"minimumRegression");
			...
			WSClient.setData("{var_addressType}", OperaPropConfig.getDataSetForCode("AddressType", "DS_01"));
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						WSClient.setData("{var_addressType}", HTNGLib.getExtValue(resortOperaValue, interfaceName, "ADDRESS_TYPES",OperaPropConfig.getDataSetForCode("AddressType", "DS_01")));
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_11");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"minimumRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_4437() {
		try {
			String testName = "updateProfile_2008_4437";
			...
			WSClient.setData("{var_nationality}", OperaPropConfig.getDataSetForCode("Nationality", "DS_01"));
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
						...
						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_13");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
		            	...
		            	updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_16");
		            	...
		            	updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_17");
		            	updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
		            	if(WSAssert.assertIfElementValueEquals(updateProfileResponseXML,"UpdateProfileResponse_Result_resultStatusFlag","SUCCESS",false)) {  
		            	...
		            	updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_18");
		            	updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
		            	if(WSAssert.assertIfElementValueEquals(updateProfileResponseXML,"UpdateProfileResponse_Result_resultStatusFlag","SUCCESS",false)) {  
		            	...
		            	updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_19");
		            	updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
		            	if(WSAssert.assertIfElementValueEquals(updateProfileResponseXML,"UpdateProfileResponse_Result_resultStatusFlag","SUCCESS",false)) {  
	...
	@Test(groups = { "minimumRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1908(){
		try{
			String testName = "updateProfile_2008_1908";
			...
			OPERALib.setOperaHeader(OPERALib.getUserName());
				...
				if (WSAssert.assertIfElementExists(createMembershipResponseXML, "CreateMembershipRS_Success", true)) {
					...
					HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
					String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_14");
					String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "minimumRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_40660() {
		try {
			String testName = "updateProfile_2008_40660";
					...
					if (WSAssert.assertIfElementExists(changeProfileResponseXML, "ChangeProfileRS_Success", true)) {
						...
						String extProfileID=WSClient.getKeywordData("{KEYWORD_RANDNUM_5}");
						  WSClient.setData("{var_E_profileID}", extProfileID);
							...
							if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
								WSClient.writeToReport(LogStatus.INFO, "<b>ExtProfileId =" + extProfileID+"</b>");
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_15");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "minimumRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_41084() {
		try {
			String testName = "updateProfile_2008_41084";
			WSClient.startTest(testName,
            ...
            OPERALib.setOperaHeader(uname);
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_20");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "targetedRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1904() {
		try {
			String testName = "updateProfile_2008_1904";
			WSClient.startTest(testName,
			...
			//Prerequisite 1: Create Profile
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_21");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "targetedRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1913() {
		try {
			String testName = "updateProfile_2008_1913";
			WSClient.startTest(testName,
            ...
            OPERALib.setOperaHeader(uname);
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_22");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
						...
						if (WSAssert.assertIfElementValueEquals(updateProfileResponseXML,
							...
							String query2=WSClient.getQuery("QS_25");
							db = WSClient.getDBRows(query2);
	...
	@Test(groups = { "targetedRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1914() {
		try {
			String testName = "updateProfile_2008_1914";
			WSClient.startTest(testName,
            ...
            OPERALib.setOperaHeader(uname);
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_23");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "targetedRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1929() {
		try {
			String testName = "updateProfile_2008_1929";
	...
	@Test(groups= {"targetedRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1916() {
		try {
			String testName = "updateProfile_2008_1916";
	...
	@Test(groups= {"targetedRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1917() {
		try {
			String testName = "updateProfile_2008_1917";
			...
			OPERALib.setOperaHeader(uname);
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
						...
						WSClient.setData("{var_phoneRole}", OperaPropConfig.getDataSetForCode("CommunicationMethod", "DS_01").toUpperCase());
						WSClient.setData("{var_primary}","true");
						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_24");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"targetedRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1922() {
		try {
			String testName = "updateProfile_2008_1922";
	...
	@Test(groups= {"targetedRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1924() {
		try {
			String testName = "updateProfile_2008_1924";
			...
			OPERALib.setOperaHeader(uname);
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
						...
						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_25");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"targetedRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1923() {
		try {
			String testName = "updateProfile_2008_1923";
	...
	@Test(groups = { "targetedRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1909(){
		try{
			String testName = "updateProfile_2008_1909";
	...
	@Test(groups = { "targetedRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1910(){
		try{
			String testName = "updateProfile_2008_1910";
			...
			OPERALib.setOperaHeader(OPERALib.getUserName());
					...
					WSClient.setData("{var_profileID}", operaProfileID);
						...
						//Validation request being created and processed to generate response
					HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
					String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_26");
					String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"minimumRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1906() {
		try {
			String testName = "updateProfile_2008_1906";
			...
			OPERALib.setOperaHeader(uname);
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
						...
						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_07");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"minimumRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1933() {
		try {
			String testName = "updateProfile_2008_1933";
	...
	@Test(groups= {"fullRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1946() {
		try {
			String testName = "updateProfile_2008_1946";
			...
			WSClient.setData("{var_phoneType}",OperaPropConfig.getDataSetForCode("CommunicationType", "DS_01"));
	            	...
	            	String query1=WSClient.getQuery("QS_04");
	            	String phn=WSClient.getDBRow(query1).get("PHONE_ID");
	            	if(!phn.equals("")){
	                WSClient.setData("{var_E_profileID}", extProfileID);
	                WSClient.setData("{var_profileSource}", HTNGLib.getHTNGInterface());
	                WSClient.setData("{var_interfaceName}", HTNGLib.getHTNGInterface());
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
						...
						WSClient.setData("{var_phoneRole}", OperaPropConfig.getDataSetForCode("CommunicationMethod", "DS_01").toUpperCase());
						WSClient.setData("{var_primary}","true");
						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_27");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"fullRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1947() {
		try {
			String testName = "updateProfile_2008_1947";
			...
			OPERALib.setOperaHeader(uname);
					...
					String query1=WSClient.getQuery("HTNG2008UpdateProfile", "QS_07");
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
						...
						String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_28");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "fullRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1941(){
		try{
			String testName = "updateProfile_2008_1941";
	...
	@Test(groups = { "fullRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1943() {
		try {
			String testName = "updateProfile_2008_1943";
					...
					if (WSAssert.assertIfElementExists(changeProfileResponseXML, "ChangeProfileRS_Success", true)) {
						...
						String extProfileID=WSClient.getKeywordData("{KEYWORD_RANDNUM_5}");
						  WSClient.setData("{var_E_profileID}", extProfileID);
							...
							if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
								WSClient.writeToReport(LogStatus.INFO, "<b>ExtProfileId =" + extProfileID+"</b>");
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_29");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "fullRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1944() {
		try {
			String testName = "updateProfile_2008_1944";
			WSClient.startTest(testName,
            ...
            OPERALib.setOperaHeader(uname);
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_30");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
						...
						updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_31");
						updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "fullRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1945() {
		try {
			String testName = "updateProfile_2008_1945";
			WSClient.startTest(testName,
			...
			//Prerequisite 1: Create Profile
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						WSClient.setData("{var_city}", addLOV.get("City"));
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_32");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "fullRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1939() {
		try {
			String testName = "updateProfile_2008_1939";
			WSClient.startTest(testName,
			...
			//Prerequisite 1: Create Profile
					...
					if (WSAssert.assertIfElementValueEquals(subscriptionRes,
						...
						WSClient.setData("{var_phoneRole}", OperaPropConfig.getDataSetForCode("CommunicationMethod", "DS_01").toUpperCase());
						HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
						String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_33");
						String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups= {"fullRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1940() {
		try {
			String testName = "updateProfile_2008_1940";
	...
	@Test(groups = { "fullRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1948(){
		try{
			String testName = "updateProfile_2008_1948";
			...
			OPERALib.setOperaHeader(OPERALib.getUserName());
				...
				if (WSAssert.assertIfElementExists(createMembershipResponseXML, "CreateMembershipRS_Success", true)) {
					...
					if (WSAssert.assertIfElementExists(createMembershipResponseXML, "CreateMembershipRS_ProfileMemberships_ProfileMembership_MembershipID", true)){ 
						...
						//Validation request being created and processed to generate response
					HTNGLib.setHTNGHeader(uname, pwd, fromAddress);
					String updateProfileReq = WSClient.createSOAPMessage("HTNG2008UpdateProfile", "DS_34");
					String updateProfileResponseXML = WSClient.processSOAPMessage(updateProfileReq);
	...
	@Test(groups = { "fullRegression", "UpdateProfile", "HTNG2008B", "HTNG" })
	public void updateProfile_2008_1949() {
		try {
			String testName = "updateProfile_2008_1949";
			WSClient.startTest(testName,
	...
	@Test(groups= {"fullRegression","UpdateProfile","HTNG2008B","HTNG"})
	public void updateProfile_2008_1938() {
		try {
			String testName = "updateProfile_2008_1938";
			...
			WSClient.setData("{var_nationality}", OperaPropConfig.getDataSetForCode("Nationality", "DS_01"));
					...
					if(WSAssert.assertIfElementValueEquals(subscriptionRes,"SubscriptionResponse_Result_resultStatusFlag", "SUCCESS",true)){
		            	...
		            	String updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_16");
		            	String updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
		            	WSAssert.assertIfElementValueEquals(updateProfileResponseXML,"UpdateProfileResponse_Result_resultStatusFlag","FAIL",false); 
		            	...
		            	updateProfileReq = WSClient.createSOAPMessage( "HTNG2008UpdateProfile", "DS_09");
		            	updateProfileResponseXML=WSClient.processSOAPMessage(updateProfileReq);
		            	WSAssert.assertIfElementValueEquals(updateProfileResponseXML,"UpdateProfileResponse_Result_resultStatusFlag","FAIL",false);
		            	if (WSAssert.assertIfElementExists(updateProfileResponseXML, "Result_Text_TextElement", true)) {
