...
import com.relevantcodes.customextentreports.LogCounts;
...
public class Test implements ITest, Serializable {
    ...
    public String getSbLogs() {
		return sbLogs;
	}

	public void setSbLogs(String sbLogs) {
		this.sbLogs = sbLogs;
	}
    ...
    public Test(long time) {
        ...
        setStartedTime(calendar.getTime());
	...
	public void setWsLogs(String wsLogs) {
		this.wsLogs = wsLogs;
	}
