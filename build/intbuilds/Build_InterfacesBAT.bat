...
set projectLocation=%projectRootRepositoryInRunningMachine%\int\auto\INTERFACESWSAuto\
set runnableJarFilesLocation=%projectRootRepositoryInRunningMachine%\catalog\intautosuites\INTERFACES\
...
call copy /Y %projectLocation%\target\INTERFACESWSAuto-1.0-SNAPSHOT-jar-with-dependencies.jar  %runnableJarFilesLocation%\INTERFACESWSAuto-1.0-SNAPSHOT-jar-with-dependencies.jar
