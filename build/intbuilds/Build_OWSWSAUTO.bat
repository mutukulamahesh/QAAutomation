...
set projectLocation=%projectRootRepositoryInRunningMachine%\int\auto\OWSWSAuto\
set runnableJarFilesLocation=%projectRootRepositoryInRunningMachine%\catalog\intautosuites\OWS\
...
call copy /Y %projectLocation%\target\OWSWSAuto-1.0-SNAPSHOT-jar-with-dependencies.jar  %runnableJarFilesLocation%\OWSWSAuto-1.0-SNAPSHOT-jar-with-dependencies.jar
